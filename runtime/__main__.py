...
def parser():
    ...
    fixed = sub.add_parser('fixed-task', help='Offline check or supervised signature/reset/shake/pickup-shake')
    fixed.add_argument('task', choices=('signature', 'reset', 'shake', 'shaker'))
